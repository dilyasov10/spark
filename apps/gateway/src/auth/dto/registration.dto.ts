...
export class RegistrationDto {
  @ApiProperty({ example: 'anna_kovaleva', description: 'Уникальный username' })
  ...
  @ApiProperty({ example: 'Password123!', description: 'Подтверждение пароля' })
  ...
  @MinLength(FIRST_NAME_MIN_LENGTH, { message: 'Имя не может быть пустым' })
  ...
  @MinLength(LAST_NAME_MIN_LENGTH, { message: 'Фамилия не может быть пустой' })
